...
import com.project2.pokemongenerator.security.jwt.JwtRequestFilter;
...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/auth/users", "/auth/users/login", "/auth/users/register", "/auth/users/list", "/auth/users/{username}", "/auth/users/{userId}", "/auth/users/{username}/changepassword").permitAll()
